...
# Dotpulse.ResponsiveTabs Package for Neos CMS #

## Composer

### Integration Repository
```
composer config repositories.button vcs ssh://hg@bitbucket.org/dotpulse/neos-plugin-responsivetabs
```

### Installation
```
composer require dotpulse/responsivetabs
```
* * *
> ##### License Terms
